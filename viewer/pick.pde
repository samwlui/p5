...
// if(Math.abs(d(a.cen, b.cen)) < (a.rad+p.rad)){
//   
//   vec ab = V(this.cen, p.cen);
//   vec nor = U(ab);
//   vec norCom1 = V(d(this.velocity, nor), nor);
//   vec norCom2 = V();
//   if(p.collided == false){
//   norCom2 = V(d(p.velocity, nor), nor);
//   }
//   else{
//     norCom2 = V(d(p.oldVelocity, nor), nor);
//   }
//   this.velocity =   A(M(this.velocity, norCom1), norCom2);
//   
//   if(p.collided == false){
//   p.velocity =  A(M(p.velocity, norCom2), norCom1);
//   }
//   else{
//     p.velocity =  A(M(p.oldVelocity, norCom2), norCom1);
//   }
//   
//   collided = true; 
// }
